...
=>
  ...
  (bind ?per (read))
  (printout t "Qué tipo de alimentación tenía el dino? (herbivoro/carnivoro/omnivoro)" crlf)
  (bind ?ali (read))
...
=>
	...
	(assert(printout t "Sus dientes y su pico curvado, como el de un loro, no eran adecuados para masticar plantas que comía, pero sí para cortar." crlf))
	(printout t crlf)
)	 
